...
from utils.feature_tag_matching import *
...
parser.add_argument("-t", "--tags", dest="tags", help="Semicolon separated list of tags to match features against.", metavar="TAG_LIST")
